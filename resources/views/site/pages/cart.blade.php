        ...
        <div class="container">
            ...
            <div class="row">
                        ...
                        <div class="card">
                            <table class="table table-hover shopping-cart-wrap">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" width="120">Précio</th>
                ...
                <aside class="col-sm-3">
                    ...
                    <p class="alert alert-success">Si tienes dudas con los métodos de págo puedes contactarnos</p>
                    ...
                    <figure class="itemside mb-3">
                        ...
                        <div class="text-wrap small text-muted">
                            Puedes usar cualquier tarjeta de visa asociada a tu cuenta de paypal.
                        </div>
                    </figure>
                    <figure class="itemside mb-3">
                        <aside class="aside"> <img src="{{ asset('frontend/images/icons/pay-mastercard.png') }}"> </aside>
                        <div class="text-wrap small text-muted">
                            Puedes pagar con master Card.
                            <br>
                        </div>
                    </figure>
                    <a href="{{ route('checkout.index') }}" class="btn btn-success btn-lg btn-block">Proceder a confirmar el págo</a>
                </aside>
            </div>
        </div>
    </section>
